...
productcontainer.className = "gallery";

// storing in a variable
let sorted = document.getElementById("sorting") ;
sorted.addEventListener("change", sort_cards);


// Event listener for filtering by category
document.getElementById("category").addEventListener("change", filter_by_category);
...
function filter_by_category() {
  ...
  getcards(filteredProducts);
}

function sort_cards() {
    // Fetch the value of the selected sorting option
  ...
  // Clear the existing cards in the container
  productcontainer.innerHTML = "";
  getcards(sortedproducts);
}
getcards(products)

function getcards(products) {
  products.forEach((_product) => {
    let card = createcard(_product);
    console.log(card);
...
function createcard(_product) {
  ...
  title.textContent = _product.title;
  ...
  rating.textContent = ` Rating: ${_product.rating.rate} (${_product.rating.count} reviews )`;
